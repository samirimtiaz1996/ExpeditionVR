...
Shader "Nature/Terrain/ColorMappedDiffuse" {
    Properties {
    ...
    CGINCLUDE
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            half weight;
            fixed4 mixedDiffuse;
            SplatmapMix(IN, splat_control, weight, mixedDiffuse, o.Normal, color_control);
    ...
    Dependency "AddPassShader" = "Hidden/TerrainEngine/Colormapped/Diffuse-AddPass"
