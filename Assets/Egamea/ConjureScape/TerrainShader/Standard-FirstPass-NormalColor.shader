...
Shader "Nature/Terrain/ColorMappedNormals" {
    Properties {

         _SplatMap ("Splat Map (RGBA)", 2D) = "red" {}
		 _ColorMap ("Color Map (RGBA)", 2D) = "white" {}
		 _ColorNormalMap ("Color Normal Map (RGBA)", 2D) = "white" {}
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Albedo = (mixedDiffuse.rgb * fadeout) + (color_control * (1-fadeout));			// base color // fixed4(fadeout,0,0,1) + (color_control * (1-fadeout)); //
            o.Alpha = 1;// weight;																	// brightness?
            o.Smoothness = 0; //mixedDiffuse.a; 														// specular
    ...
    Dependency "BaseMapShader" = "Hidden/TerrainEngine/Colormapped/Standard-Base-Normals"
