...
Shader "Hidden/TerrainEngine/Colormapped/Standard-AddPass" {
    Properties {
        // set by terrain engine
        [HideInInspector] _Control ("Control (RGBA)", 2D) = "red" {}
        [HideInInspector] _SplatMap ("Splat Map (RGBA)", 2D) = "red" {}
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Albedo = mixedDiffuse.rgb; o.Albedo = fixed4(1,0,0,1);
            o.Alpha = weight;
            o.Smoothness = mixedDiffuse.a; o.Smoothness = fixed4(1,1,1,1);
